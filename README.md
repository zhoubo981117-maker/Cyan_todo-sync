...
随记收件箱支持按来源、AI 状态、类型、标签、是否已关联任务和关键字筛选。失败记录可以在详情中点击“重试整理”；批量清理只会软删除当前账号的随记记录，关联任务会保留。
...
任务勾选完成后会从“活跃待办”移入当前账号的归档。点击“归档中心”可以查看已完成任务，按标题/备注、完成时间和优先级筛选，并在误操作时点击“恢复”让任务回到活跃待办。归档不是删除，另一个账号无法看到当前账号的归档任务。
